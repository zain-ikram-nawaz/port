  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="service container mx-auto xs:grid grid-cols-4 xs:w-2/4 sm:grid grid-cols-4 md:grid grid-cols-4 lg:grid-cols-4 gap-8">
